...
@media(max-width:560px){
  ...
  function initSearchOverlay() {
    ...
    const WARDS_DATA = [
      ...
      { id: 1001, name: 'Toàn tỉnh Tiền Giang', district: 'Tiền Giang', lat: 10.3542, lon: 106.3574 },
      { id: 1002, name: 'Toàn tỉnh Bến Tre', district: 'Bến Tre', lat: 10.2435, lon: 106.3753 },
      { id: 1003, name: 'Toàn tỉnh Đồng Tháp', district: 'Đồng Tháp', lat: 10.4571, lon: 105.6322 },
      { id: 1004, name: 'Toàn tỉnh Vĩnh Long', district: 'Vĩnh Long', lat: 10.2524, lon: 105.9754 },
      { id: 1005, name: 'Toàn tỉnh Trà Vinh', district: 'Trà Vinh', lat: 9.9329, lon: 106.3409 },
      { id: 1006, name: 'Toàn tỉnh Hậu Giang', district: 'Hậu Giang', lat: 9.7842, lon: 105.4715 },
      ...
      { id: 2002, name: 'Q. Bình Thủy', district: 'Cần Thơ', lat: 10.0667, lon: 105.7333 },
      { id: 2003, name: 'Q. Cái Răng', district: 'Cần Thơ', lat: 9.9833, lon: 105.7667 },
      { id: 2004, name: 'Q. Ô Môn', district: 'Cần Thơ', lat: 10.1167, lon: 105.6167 },
      { id: 2005, name: 'Q. Thốt Nốt', district: 'Cần Thơ', lat: 10.2667, lon: 105.5333 },
      { id: 2006, name: 'H. Cờ Đỏ', district: 'Cần Thơ', lat: 10.1333, lon: 105.4667 },
      { id: 2007, name: 'H. Phong Điền', district: 'Cần Thơ', lat: 9.9833, lon: 105.6667 },
      { id: 2008, name: 'H. Thới Lai', district: 'Cần Thơ', lat: 10.0667, lon: 105.5333 },
      { id: 2009, name: 'H. Vĩnh Thạnh', district: 'Cần Thơ', lat: 10.2000, lon: 105.3833 },

      { id: 2101, name: 'TP. Mỹ Tho', district: 'Tiền Giang', lat: 10.3667, lon: 106.3667 },
      { id: 2102, name: 'TX. Cai Lậy', district: 'Tiền Giang', lat: 10.4000, lon: 106.1167 },
      { id: 2103, name: 'TX. Gò Công', district: 'Tiền Giang', lat: 10.3667, lon: 106.6667 },
      { id: 2104, name: 'H. Cái Bè', district: 'Tiền Giang', lat: 10.3667, lon: 106.0000 },
      { id: 2105, name: 'H. Châu Thành', district: 'Tiền Giang', lat: 10.3833, lon: 106.2833 },
      { id: 2106, name: 'H. Chợ Gạo', district: 'Tiền Giang', lat: 10.3667, lon: 106.4667 },
      { id: 2107, name: 'H. Gò Công Tây', district: 'Tiền Giang', lat: 10.3333, lon: 106.6000 },
      { id: 2108, name: 'H. Gò Công Đông', district: 'Tiền Giang', lat: 10.3000, lon: 106.6833 },
      { id: 2109, name: 'H. Tân Phước', district: 'Tiền Giang', lat: 10.4833, lon: 106.2833 },
      { id: 2110, name: 'H. Tân Phú Đông', district: 'Tiền Giang', lat: 10.2333, lon: 106.6667 },

      { id: 2201, name: 'TP. Bến Tre', district: 'Bến Tre', lat: 10.2333, lon: 106.3833 },
      { id: 2202, name: 'H. Ba Tri', district: 'Bến Tre', lat: 10.0500, lon: 106.6000 },
      { id: 2203, name: 'H. Bình Đại', district: 'Bến Tre', lat: 10.1833, lon: 106.6333 },
      { id: 2204, name: 'H. Châu Thành', district: 'Bến Tre', lat: 10.2833, lon: 106.3333 },
      { id: 2205, name: 'H. Chợ Lách', district: 'Bến Tre', lat: 10.2333, lon: 106.1333 },
      { id: 2206, name: 'H. Giồng Trôm', district: 'Bến Tre', lat: 10.1500, lon: 106.4667 },
      { id: 2207, name: 'H. Mỏ Cày Bắc', district: 'Bến Tre', lat: 10.1667, lon: 106.3000 },
      { id: 2208, name: 'H. Mỏ Cày Nam', district: 'Bến Tre', lat: 10.0667, lon: 106.3000 },
      { id: 2209, name: 'H. Thạnh Phú', district: 'Bến Tre', lat: 9.9667, lon: 106.5167 },

      { id: 2301, name: 'TP. Cao Lãnh', district: 'Đồng Tháp', lat: 10.4500, lon: 105.6333 },
      { id: 2302, name: 'TP. Sa Đéc', district: 'Đồng Tháp', lat: 10.2833, lon: 105.7667 },
      { id: 2303, name: 'TP. Hồng Ngự', district: 'Đồng Tháp', lat: 10.8000, lon: 105.3167 },
      { id: 2304, name: 'H. Châu Thành', district: 'Đồng Tháp', lat: 10.2167, lon: 105.8000 },
      { id: 2305, name: 'H. Lai Vung', district: 'Đồng Tháp', lat: 10.2667, lon: 105.6667 },
      { id: 2306, name: 'H. Lấp Vò', district: 'Đồng Tháp', lat: 10.3500, lon: 105.5333 },
      { id: 2307, name: 'H. Tam Nông', district: 'Đồng Tháp', lat: 10.6667, lon: 105.5500 },
      { id: 2308, name: 'H. Tân Hồng', district: 'Đồng Tháp', lat: 10.8333, lon: 105.4500 },
      { id: 2309, name: 'H. Thanh Bình', district: 'Đồng Tháp', lat: 10.5333, lon: 105.4500 },
      { id: 2310, name: 'H. Tháp Mười', district: 'Đồng Tháp', lat: 10.5167, lon: 105.8167 },

      { id: 2401, name: 'TP. Vĩnh Long', district: 'Vĩnh Long', lat: 10.2500, lon: 105.9667 },
      { id: 2402, name: 'TX. Bình Minh', district: 'Vĩnh Long', lat: 10.0500, lon: 105.8167 },
      { id: 2403, name: 'H. Bình Tân', district: 'Vĩnh Long', lat: 10.1000, lon: 105.7667 },
      { id: 2404, name: 'H. Long Hồ', district: 'Vĩnh Long', lat: 10.2000, lon: 106.0167 },
      { id: 2405, name: 'H. Mang Thít', district: 'Vĩnh Long', lat: 10.1500, lon: 106.0833 },
      { id: 2406, name: 'H. Tam Bình', district: 'Vĩnh Long', lat: 10.0833, lon: 105.9833 },
      { id: 2407, name: 'H. Trà Ôn', district: 'Vĩnh Long', lat: 9.9667, lon: 105.9333 },
      { id: 2408, name: 'H. Vũng Liêm', district: 'Vĩnh Long', lat: 10.0833, lon: 106.1833 },

      { id: 2501, name: 'TP. Trà Vinh', district: 'Trà Vinh', lat: 9.9333, lon: 106.3333 },
      { id: 2502, name: 'TX. Duyên Hải', district: 'Trà Vinh', lat: 9.6833, lon: 106.5000 },
      { id: 2503, name: 'H. Càng Long', district: 'Trà Vinh', lat: 10.0000, lon: 106.2000 },
      { id: 2504, name: 'H. Cầu Kè', district: 'Trà Vinh', lat: 9.8500, lon: 106.0500 },
      { id: 2505, name: 'H. Cầu Ngang', district: 'Trà Vinh', lat: 9.8000, lon: 106.4167 },
      { id: 2506, name: 'H. Châu Thành', district: 'Trà Vinh', lat: 9.8667, lon: 106.3333 },
      { id: 2507, name: 'H. Tiểu Cần', district: 'Trà Vinh', lat: 9.8000, lon: 106.2167 },
      { id: 2508, name: 'H. Trà Cú', district: 'Trà Vinh', lat: 9.7000, lon: 106.2667 },

      { id: 2601, name: 'TP. Vị Thanh', district: 'Hậu Giang', lat: 9.7833, lon: 105.4667 },
      { id: 2602, name: 'TP. Ngã Bảy', district: 'Hậu Giang', lat: 9.8167, lon: 105.8167 },
      { id: 2603, name: 'TX. Long Mỹ', district: 'Hậu Giang', lat: 9.6833, lon: 105.5500 },
      { id: 2604, name: 'H. Châu Thành', district: 'Hậu Giang', lat: 9.9333, lon: 105.8167 },
      { id: 2605, name: 'H. Châu Thành A', district: 'Hậu Giang', lat: 9.9167, lon: 105.6667 },
      { id: 2606, name: 'H. Phụng Hiệp', district: 'Hậu Giang', lat: 9.7667, lon: 105.7333 },
      { id: 2607, name: 'H. Vị Thủy', district: 'Hậu Giang', lat: 9.8333, lon: 105.5167 },

      { id: 2701, name: 'TP. Long Xuyên', district: 'An Giang', lat: 10.3833, lon: 105.4333 },
      { id: 2702, name: 'TP. Châu Đốc', district: 'An Giang', lat: 10.7167, lon: 105.1167 },
      { id: 2703, name: 'TX. Tân Châu', district: 'An Giang', lat: 10.8000, lon: 105.1833 },
      { id: 2704, name: 'H. An Phú', district: 'An Giang', lat: 10.8833, lon: 105.0833 },
      { id: 2705, name: 'H. Châu Phú', district: 'An Giang', lat: 10.5667, lon: 105.2167 },
      { id: 2706, name: 'H. Châu Thành', district: 'An Giang', lat: 10.4500, lon: 105.3333 },
      { id: 2707, name: 'H. Chợ Mới', district: 'An Giang', lat: 10.4500, lon: 105.5000 },
      { id: 2708, name: 'H. Phú Tân', district: 'An Giang', lat: 10.6667, lon: 105.3333 },
      { id: 2709, name: 'H. Thoại Sơn', district: 'An Giang', lat: 10.3000, lon: 105.2833 },
      { id: 2710, name: 'H. Tịnh Biên', district: 'An Giang', lat: 10.6000, lon: 104.9667 },
      { id: 2711, name: 'H. Tri Tôn', district: 'An Giang', lat: 10.4000, lon: 104.9833 },

      { id: 2801, name: 'TP. Sóc Trăng', district: 'Sóc Trăng', lat: 9.6000, lon: 105.9667 },
      { id: 2802, name: 'TX. Vĩnh Châu', district: 'Sóc Trăng', lat: 9.3167, lon: 106.0167 },
      { id: 2803, name: 'TX. Ngã Năm', district: 'Sóc Trăng', lat: 9.5833, lon: 105.6667 },
      { id: 2804, name: 'H. Châu Thành', district: 'Sóc Trăng', lat: 9.6833, lon: 105.9167 },
      { id: 2805, name: 'H. Cù Lao Dung', district: 'Sóc Trăng', lat: 9.6167, lon: 106.1500 },
      { id: 2806, name: 'H. Kế Sách', district: 'Sóc Trăng', lat: 9.7833, lon: 105.9833 },
      { id: 2807, name: 'H. Long Phú', district: 'Sóc Trăng', lat: 9.6667, lon: 106.0667 },
      { id: 2808, name: 'H. Mỹ Tú', district: 'Sóc Trăng', lat: 9.6167, lon: 105.8000 },
      { id: 2809, name: 'H. Mỹ Xuyên', district: 'Sóc Trăng', lat: 9.5167, lon: 105.9167 },
      { id: 2810, name: 'H. Thạnh Trị', district: 'Sóc Trăng', lat: 9.4833, lon: 105.7833 },
      { id: 2811, name: 'H. Trần Đề', district: 'Sóc Trăng', lat: 9.4833, lon: 106.1000 },

      { id: 2901, name: 'TP. Rạch Giá', district: 'Kiên Giang', lat: 10.0167, lon: 105.0833 },
      { id: 2902, name: 'TP. Hà Tiên', district: 'Kiên Giang', lat: 10.3833, lon: 104.4833 },
      { id: 2903, name: 'TP. Phú Quốc', district: 'Kiên Giang', lat: 10.2167, lon: 103.9667 },
      { id: 2904, name: 'H. An Biên', district: 'Kiên Giang', lat: 9.7500, lon: 105.0333 },
      { id: 2905, name: 'H. An Minh', district: 'Kiên Giang', lat: 9.6000, lon: 104.9333 },
      { id: 2906, name: 'H. Châu Thành', district: 'Kiên Giang', lat: 9.9333, lon: 105.1500 },
      { id: 2907, name: 'H. Giang Thành', district: 'Kiên Giang', lat: 10.5167, lon: 104.5667 },
      { id: 2908, name: 'H. Giồng Riềng', district: 'Kiên Giang', lat: 9.8333, lon: 105.3000 },
      { id: 2909, name: 'H. Gò Quao', district: 'Kiên Giang', lat: 9.7333, lon: 105.2167 },
      { id: 2910, name: 'H. Hòn Đất', district: 'Kiên Giang', lat: 10.1500, lon: 104.8833 },
      { id: 2911, name: 'H. Kiên Hải', district: 'Kiên Giang', lat: 9.8000, lon: 104.8667 },
      { id: 2912, name: 'H. Kiên Lương', district: 'Kiên Giang', lat: 10.2500, lon: 104.6000 },
      { id: 2913, name: 'H. Tân Hiệp', district: 'Kiên Giang', lat: 10.0833, lon: 105.3167 },
